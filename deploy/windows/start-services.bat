...
echo ==============================================================================
echo  Starting Pepsi Depot Services...
echo ==============================================================================
...
if %HAS_NSSM% equ 1 "%NSSM_EXE%" start "!WEB_SVC!" >nul 2>&1

echo Starting: !SYNC_SVC!
net start "!SYNC_SVC!" >nul 2>&1
if %HAS_NSSM% equ 1 "%NSSM_EXE%" start "!SYNC_SVC!" >nul 2>&1
